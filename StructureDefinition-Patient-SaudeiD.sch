...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      ...
      <sch:assert test="count(f:extension[@url = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-occupation']) &lt;= 1">extension with URL = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-occupation': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-prontmedCode']) &lt;= 1">extension with URL = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-prontmedCode': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-mothersName']) &lt;= 1">extension with URL = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-mothersName': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-fathersName']) &lt;= 1">extension with URL = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-fathersName': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-agreedWithUserTerms']) &lt;= 1">extension with URL = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-agreedWithUserTerms': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-biologicalSex']) &lt;= 1">extension with URL = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-biologicalSex': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-ethnicity']) &lt;= 1">extension with URL = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-ethnicity': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-lastUpdate']) &lt;= 1">extension with URL = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-lastUpdate': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-isB2C']) &lt;= 1">extension with URL = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-isB2C': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-isB2B']) &lt;= 1">extension with URL = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-isB2B': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-deviceOperationalSystem']) &lt;= 1">extension with URL = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-deviceOperationalSystem': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-idDocumentoFleury']) &lt;= 1">extension with URL = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-idDocumentoFleury': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-idClienteFleury']) &lt;= 1">extension with URL = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-idClienteFleury': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-idWorkstation']) &lt;= 1">extension with URL = 'http://saudeid-data.github.io/fhir/StructureDefinition/patient-idWorkstation': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>Patient.managingOrganization.type</sch:title>
    <sch:rule context="f:Patient/f:managingOrganization/f:type">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
